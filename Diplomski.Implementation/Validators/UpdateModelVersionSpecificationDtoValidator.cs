...
{
    public class UpdateModelVersionSpecificationDtoValidator : AbstractValidator<UpdateModelVersionSpecificationDto>
    {
        public UpdateModelVersionSpecificationDtoValidator(DatabaseContext context)
        {
